...
if(isset($_GET['id']))
{
    ...
    if(preg_match($regex1, $id)){
        echo "<font size='5'/>Get out, hacker";
        echo "<br>";
    ...
    while($row=mysqli_fetch_array($result))
    {
        ...
        echo '<font size="5"/>Your Login name:'. $row['username'];
    ...
    echo "<font size='5'/>Welcome to NYNU CTF";
    echo "</br>";
    echo "</br>";
    echo "</br>";
    echo "<font size='4'/>There's nothing";
